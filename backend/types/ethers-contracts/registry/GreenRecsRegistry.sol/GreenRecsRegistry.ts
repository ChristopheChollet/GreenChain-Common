...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface GreenRecsRegistryInterface extends Interface {
    getFunction(nameOrSignature: "balanceOf" | "balanceOfBatch" | "carbonCredits" | "isApprovedForAll" | "issue" | "owner" | "renounceOwnership" | "retire" | "safeBatchTransferFrom" | "safeTransferFrom" | "setApprovalForAll" | "supportsInterface" | "transferOwnership" | "uri"): FunctionFragment;

    getEvent(nameOrSignatureOrTopic: "ApprovalForAll" | "Issued" | "OwnershipTransferred" | "Retired" | "TransferBatch" | "TransferSingle" | "URI"): EventFragment;
...
encodeFunctionData(functionFragment: 'carbonCredits', values?: undefined): string;
encodeFunctionData(functionFragment: 'isApprovedForAll', values: [AddressLike, AddressLike]): string;
encodeFunctionData(functionFragment: 'issue', values: [AddressLike, BigNumberish, BigNumberish, string]): string;
encodeFunctionData(functionFragment: 'owner', values?: undefined): string;
encodeFunctionData(functionFragment: 'renounceOwnership', values?: undefined): string;
encodeFunctionData(functionFragment: 'retire', values: [BigNumberish, BigNumberish, string]): string;
...
decodeFunctionResult(functionFragment: 'carbonCredits', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'uri', data: BytesLike): Result;
    ...
    export namespace IssuedEvent {
      export type InputTuple = [to: AddressLike, id: BigNumberish, amount: BigNumberish, uri: string];
      export type OutputTuple = [to: string, id: bigint, amount: bigint, uri: string];
      export interface OutputObject {to: string, id: bigint, amount: bigint, uri: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace RetiredEvent {
      export type InputTuple = [from: AddressLike, id: BigNumberish, amount: BigNumberish, reason: string];
      export type OutputTuple = [from: string, id: bigint, amount: bigint, reason: string];
      export interface OutputObject {from: string, id: bigint, amount: bigint, reason: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
  ...
  export interface GreenRecsRegistry extends BaseContract {
    
    connect(runner?: ContractRunner | null): GreenRecsRegistry;
    waitForDeployment(): Promise<this>;

    interface: GreenRecsRegistryInterface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    carbonCredits: TypedContractMethod<
      [],
      [string],
      'view'
    >
    ...
    issue: TypedContractMethod<
      [to: AddressLike, id: BigNumberish, amount: BigNumberish, tokenUri: string, ],
      [void],
      'nonpayable'
    >
    ...
    retire: TypedContractMethod<
      [id: BigNumberish, amount: BigNumberish, reason: string, ],
      [void],
      'nonpayable'
    >
...
getFunction(nameOrSignature: 'balanceOfBatch'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'carbonCredits'): TypedContractMethod<
      [],
      [string],
      'view'
    >;
getFunction(nameOrSignature: 'isApprovedForAll'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'issue'): TypedContractMethod<
      [to: AddressLike, id: BigNumberish, amount: BigNumberish, tokenUri: string, ],
      [void],
      'nonpayable'
    >;
...
getFunction(nameOrSignature: 'renounceOwnership'): TypedContractMethod<
      ...
      'nonpayable'
    >;
getFunction(nameOrSignature: 'retire'): TypedContractMethod<
      [id: BigNumberish, amount: BigNumberish, reason: string, ],
      [void],
      'nonpayable'
    >;
...
getEvent(key: 'Retired'): TypedContractEvent<RetiredEvent.InputTuple, RetiredEvent.OutputTuple, RetiredEvent.OutputObject>;
...
getEvent(key: 'URI'): TypedContractEvent<URIEvent.InputTuple, URIEvent.OutputTuple, URIEvent.OutputObject>;
    ...
    filters: {
      ...
      'Issued(address,uint256,uint256,string)': TypedContractEvent<IssuedEvent.InputTuple, IssuedEvent.OutputTuple, IssuedEvent.OutputObject>;
      ...
      'Retired(address,uint256,uint256,string)': TypedContractEvent<RetiredEvent.InputTuple, RetiredEvent.OutputTuple, RetiredEvent.OutputObject>;
      Retired: TypedContractEvent<RetiredEvent.InputTuple, RetiredEvent.OutputTuple, RetiredEvent.OutputObject>;
